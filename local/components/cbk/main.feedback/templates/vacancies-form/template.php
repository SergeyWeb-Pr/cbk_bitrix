...
<form action="<?= POST_FORM_ACTION_URI ?>" method="POST" class="form" enctype="multipart/form-data">
	...
	<div class="form__subtitle js-form-subtitle">Вакансия</div>
	<input class="js-form-hidden" type="hidden" id="vacancyInput" name="user_vacancy" value="">
	<label class="form__label">
		<input type="text" name="user_name" class="input-reset form__input" placeholder="Ваше имя"
