...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"TMP_PAGE" =>array(
			...
			"MULTIPLE" => "N",
			"DEFAULT" => "-",
			"VALUES" => ["LIGHT"=>"Light page","ABOUT"=>"About page","HISTORY"=>"Hostory page","CONTACT"=>"Contact page","QUALITY"=>"Quality page","POLITICA"=>"Politica page","BLAGODARNOST"=>"Blagodarnost page","SEARCH"=>"Search page","REFERENS"=>"Referens page","REFERENS_MAP"=>"Referens map page","RUKOVODSTVO"=>"Rukovodstvo map page","PROIZVODSTVO"=>"Proizvodstvo map page","SKLAD_DOSTAVKA"=>"Sklad i dostavka map page","MATERIAL_DOWNLOAD"=>"Material for download page","MATERIAL_DOWNLOAD_EX"=>"Material ex for download page","GOST"=>"Gost page","PRESSCENTR"=>"Press centr page"],
		),
	),
);
