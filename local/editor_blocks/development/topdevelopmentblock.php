...
class TopDevelopmentBlock extends Component
{
    ...
    public function render()
    {
        ...
        <div <?php if (!empty($fields['block_id'])): ?> id="<?php echo $fields['block_id']; ?>" <?php endif; ?>
            ...
            <section class="preview breadcrumbs-inv development-preview">
                ...
                <div class="swiper preview__swiper">
                    <div class="swiper-wrapper">
                        ...
                        <?php foreach ($development_items as $arItem): ?>
                            ...
                            if (!empty($arItem['development_text'])):
                                $development_text = $arItem['development_text'];
                            endif;
                            ...
                            <div class="swiper-slide">
                                <div class="preview__item development-preview__item">
                                    <?php if (!empty($bg_image_desktop)): ?>
                                        <div class="preview__image development-preview__image">
                                            <picture>
                                    ...
                                    <?php endif; ?>
                                    <div class="container">
                                        <div class="preview__content development-preview__content">
                                            <?php if (!empty($development_title)): ?>
                                                <h1 class="preview__title development-preview__title h1"><?php echo $development_title; ?></h1>
                                            <?php endif; ?>
                                            <?php if (!empty($development_text)): ?>
                                                <div
                                                    class="preview__text development-preview__text"><?php echo $development_text; ?></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
