...
class ContentProvisionBlock extends Component
{
    protected static $type = 'component';
    protected static $tab_name = 'Лесообеспечение';
    ...
    public function render()
    {
        ...
        <div <?php if (!empty($fields['block_id'])): ?> id="<?php echo $fields['block_id']; ?>" <?php endif; ?>
            ...
            <section class="provision">
                ...
                <div class="container">
                    <?php if (!empty($title)): ?>
                        <h1 class="provision__title h1"><?php echo $title; ?></h1>
                    <?php endif; ?>
                    <?php if (!empty($text)): ?>
                        <h3 class="provision__subtitle h3"><?php echo $text; ?></h3>
                    <?php endif; ?>
                    <div class="provision-cooperation">
                        <div class="provision-cooperation__items">

                            <?php foreach ($steps as $arItem): ?>
                                <div class="provision-cooperation__item">
                                    <?php $image = \CFile::GetPath($arItem['image']); ?>
                                    <?php if (!empty($image)): ?>
                                        <div class="provision-cooperation__item-image">
                                            <div class="provision-cooperation__item-image-inner">
                                                <img loading="lazy"
                                                     src="<?= $image ?>"
                                    ...
                                    <?php endif; ?>
                                    <div class="provision-cooperation__item-content">
                                        <?php if (!empty($arItem['name'])): ?>
                                            <h5 class="provision-cooperation__item-step h5"><?= $arItem['name'] ?></h5>
                                        <?php endif; ?>
                                        <?php if (!empty($arItem['text'])): ?>
                                            <div class="provision-cooperation__item-info"><?= $arItem['text'] ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                    ...
                    <div class="provision-info">
                        <?php if (!empty($info_title)): ?>
                            <h3 class="provision-info__title h3"><?php echo $info_title; ?></h3>
                        <?php endif; ?>
                        <div class="provision-info__items">
                            ...
                            <?php foreach ($documents as $document): ?>
                                ...
                                <div class="doc-info provision-info__item">
                                    <div class="doc-info__icon">
                                        <div class="doc-info__icon-inner">
                                            <img loading="lazy"
                                                 src="<?= SITE_TEMPLATE_PATH ?>/assets/img/svg/icons/file.svg" class="image"
                                                 width="" height=""
                                                 alt="">
                                        </div>
                                    </div>
                                    <div class="doc-info__content">
                                        <a href="<?php echo $fileUrl; ?>" class="doc-info__name" target="_blank"><?php echo $document_name; ?></a>
