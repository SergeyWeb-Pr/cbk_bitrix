...
class LineSvetoPaperBlock extends Component
{
    protected static $type = 'component';
    protected static $tab_name = 'Офисная бумага';
    protected static $label = 'Блок Линейка продукции SvetoCopy';
    ...
    public static function get_fields()
    {
        ...
        $arFields = [
            ...
            [
                'type' => 'group',
                'settings' => [
                    'label' => 'Блок с ссылками',
                    'group' => 'Блок с ссылками',
                    'name' => 'buttons_items',
                    'fields' => [
                        [
                            'type' => 'text',
        ...
        <div <?php if (!empty($fields['block_id'])): ?> id="<?php echo $fields['block_id']; ?>" <?php endif; ?>
            ...
            <section class="section-color paper-line">
                <div class="container">
                    ...
                    <?php endif; ?>
                    <?php if (!empty($buttons_items)): ?>
                    <div class="paper-line__more info">
                        <?php foreach ($buttons_items
                    ...
                    ?>
                            <a href="<?php echo $link; ?>"
                               class="button-tab preview-image__link paper-line__link"
